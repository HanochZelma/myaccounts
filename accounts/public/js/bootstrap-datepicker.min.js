  ...
  k.prototype = {
    ...
    getClassNames: function (b) {
      ...
      return (
        ...
        this.range && (b > this.range[0] && b < this.range[this.range.length - 1] && c.push('range'), -1 !== a.inArray(b.valueOf(), this.range) && c.push('selected'), b.valueOf() === this.range[0] && c.push('range-start'), b.valueOf() === this.range[this.range.length - 1] && c.push('range-end')),
        c
      );
    },
    _fill_yearsView: function (c, d, e, f, g, h, i) {
      for (
        ...
        (j = [d]),
          ...
          t === r && j.push('focused'),
          i !== a.noop && ((l = i(new Date(t, 0, 1))), l === b ? (l = {}) : 'boolean' == typeof l ? (l = { enabled: l }) : 'string' == typeof l && (l = { classes: l }), !1 === l.enabled && j.push('disabled'), l.classes && (j = j.concat(l.classes.split(/\s+/))), l.tooltip && (k = l.tooltip)),
